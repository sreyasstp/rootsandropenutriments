...
export function CataloguePage() {
  ...
  return (
    <div className="fixed inset-0 top-20 bg-gray-50">
      <div className="absolute top-0 left-0 right-0 z-10 bg-white shadow-sm border-b border-gray-200">
        <div className="flex items-center justify-between px-2 sm:px-6 py-2 sm:py-3">
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <span className="text-xs sm:text-sm text-gray-700 min-w-[50px] sm:min-w-[70px] text-center">
              {pageNumber} / {numPages}
            </span>
            <button
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <button
              ...
              className="bg-[#004606] text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg hover:bg-[#006609] transition-colors flex items-center gap-1 sm:gap-2 text-xs sm:text-sm"
            >
      ...
      <div id="pdf-container" className="w-full h-full pt-12 sm:pt-14 overflow-auto pb-16">
          ...
          <Document
            ...
            loading={
              <div className="flex items-center justify-center h-[400px] sm:h-[600px]">
                <div className="text-gray-500 text-xs sm:text-sm">Loading catalogue...</div>
              </div>
            }
            error={
              <div className="flex items-center justify-center h-[400px] sm:h-[600px]">
                <div className="text-red-500 text-xs sm:text-sm">Failed to load PDF</div>
              </div>
            }
          >
            <Page
              ...
              loading={
                <div className="flex items-center justify-center h-[400px] sm:h-[600px] bg-white">
                  <div className="text-gray-500 text-xs sm:text-sm">Loading page...</div>
                </div>
              }
              className="shadow-lg"
            />
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-3 text-center z-10">
        <a
          href="https://wa.me/917012426181?text=Hi,%20I%20want%20to%20order%20from%20your%20catalogue"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 bg-green-600 text-white font-semibold px-6 py-2.5 rounded-lg hover:bg-green-700 transition-all duration-300 shadow-lg text-sm"
        >
